...
def main():
    ...
    plt.suptitle('Sample Predictions — EfficientNet', fontsize=13)
    plt.tight_layout()
    plt.savefig(PREDICTIONS_DIR / 'predict_sample_efficientnet.png', dpi=150)
    print("Saved to outputs/predictions/")
